...
class MyColor {
  static const appBarColor = Color(0xFF1E293B);
  static const backgroundColor = Color(0xFF0E1424);
  static const secondaryColor = Color(0xffa6a6a6);
  static const iconGrayColor = Color(0xff767676);
